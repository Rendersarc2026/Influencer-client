...
- **Rule**: `try_files $uri /index.html` in `nginx/default.conf` ensures deep linking across client routes (`/agency/campaigns/:id`, `/brand/payments`, etc.) resolves without HTTP 404s.
